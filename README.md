...
I did not use AI at all during the setup of the project, since I wanted to have a very good understanding of the basic architecture of the app and the technical tradeoffs I was making. After setting up the basic skeleton and backend, I am planning to use Claude Code to help me code the frontend React pages quickly, since I have a good amount of experience with React already.
